...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['store-owner', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Carts', path: '/carts', entity: 'cart', service: AccessServiceEnum.PROJECT, icon: FiShoppingCart },
    { name: 'Categories', path: '/categories', entity: 'category', service: AccessServiceEnum.PROJECT, icon: FiTag },
