...
export function BusinessListPage(props: BusinessListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getBusinesses({
        relations: ['user', 'category.count', 'product.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['description.contains', 'location.contains', 'business_hours.contains', 'name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'business_hours', header: 'Business Hours', accessorKey: 'business_hours' },
    ...
    hasAccess('category', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => record?._count?.category,
        }
      : null,
