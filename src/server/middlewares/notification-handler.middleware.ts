...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order_created.create': { roles: ['store-owner'], key: 'order_id', tenantPath: [], userPath: [] },
  'product_updated.update': { roles: ['store-owner'], key: 'product_id', tenantPath: [], userPath: [] },
  'inventory_updated.update': { roles: ['store-owner'], key: 'inventory_id', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['store-owner'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['store-owner', 'customer'];
